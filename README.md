...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-25 21:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/29abc122-3743-4a84-ac8c-d0ecdbfacb6b.git
$ cd 29abc122-3743-4a84-ac8c-d0ecdbfacb6b
```
